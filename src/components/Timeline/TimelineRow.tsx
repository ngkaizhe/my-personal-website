...
export const TimelineRow = ({
    ...
    return (
        ...
        >
            ...
            <div className="z-20 flex items-center order-1 bg-surface shadow-xl w-12 h-12 rounded-full border-4 border-surface justify-center group-hover:scale-110 transition-transform">
