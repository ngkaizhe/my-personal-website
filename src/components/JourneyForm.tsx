        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-sm border border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input name="yearColor" defaultValue={item?.yearColor || 'text-blue-600'} required className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="text-blue-600" />
                </div>
                ...
                <div>
                    ...
                    <input name="titleColor" defaultValue={item?.titleColor || 'text-blue-600'} required className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="text-blue-600" />
                </div>
                ...
                <div>
                    ...
                    <input name="categoryColor" defaultValue={item?.categoryColor || 'bg-blue-100 text-blue-800'} required className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="bg-blue-100 text-blue-800" />
                </div>

                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Icon Name (Lucide string, e.g., briefcase)</label>
                    <input name="iconName" defaultValue={item?.icon?.name || 'help-circle'} required className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="briefcase" />
