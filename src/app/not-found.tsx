            ...
            <div className="max-w-xl w-full space-y-8 text-center">
                <div className="flex justify-center">
                    <div className="w-20 h-20 rounded-2xl bg-surface-elevated border border-border-light flex items-center justify-center">
                        <Compass className="w-10 h-10 text-text-muted" aria-hidden="true" />
                    </div>
                </div>
                <div className="space-y-3">
                    <p className="text-xs font-mono text-text-faint tracking-widest uppercase">404 — Not found</p>
                    <h1 className="text-4xl md:text-5xl font-bold text-text-primary tracking-tight">
                        Lost in the timeline.
                    </h1>
                    <p className="text-base md:text-lg text-text-muted leading-relaxed max-w-md mx-auto">
                        This page either never existed or has been deleted. Try the home page, or peek at the demo portfolio.
                    </p>
                </div>
