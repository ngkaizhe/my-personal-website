        ...
        <main className="min-h-screen bg-page flex items-center justify-center px-6 py-12">
            <div className="max-w-xl w-full space-y-8 text-center">
                ...
                <div className="space-y-3">
                    <p className="text-xs font-mono text-text-faint tracking-widest uppercase">404 — Profile not found</p>
                    <h1 className="text-4xl md:text-5xl font-bold text-text-primary tracking-tight">
                        No one&apos;s here yet.
                    </h1>
                    <p className="text-base md:text-lg text-text-muted leading-relaxed max-w-md mx-auto">
                        That username doesn&apos;t belong to anyone — maybe a typo, maybe it&apos;s still up for grabs. You could be the one to claim it.
                    </p>
                </div>
